...
function check_name(name)
{
    ...
    const disallowed_names = [
        ...
        "onboard_led_on", "prev_config", "next_config", "overlay", "oled_layout", "oled_type", "invert_oled", "rotate_oled", "i2c_interface", "oled_sda",
        "oled_scl", "oled_animation_delay", "oled_combo_idle_frame", "user_combos", "MyButton",
      ];

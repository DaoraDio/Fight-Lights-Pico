...
function show_eightway_modal(showmodal = true)
{
    ...
    for (var i = 1, row; row = table.rows[i]; i++) 
    {
        ...
        col = col.split("\t");
        if(col[0] == selected_up.text)
            select_up_replace +=  '<option value="' + col[0] + '"selected>' + col[0] +'</option>';
        else
            select_up_replace +=  '<option value="' + col[0] + '">' + col[0] +'</option>';

        if(col[0] == selected_left.text)
            select_left_replace +=  '<option value="' + col[0] + '"selected>' + col[0] +'</option>';
        else
            select_left_replace += '<option value="' + col[0] + '">' + col[0] +'</option>';

        if(col[0] == selected_right.text)
            select_right_replace +=  '<option value="' + col[0] + '"selected>' + col[0] +'</option>';
        else
            select_right_replace +=  '<option value="' + col[0] + '">' + col[0] +'</option>';

        if(col[0] == selected_down.text)
            select_down_replace +=  '<option value="' + col[0] + '"selected>' + col[0] +'</option>';
        else
            select_down_replace +=  '<option value="' + col[0] + '">' + col[0] +'</option>';
    ...
    select_up.innerHTML = select_up_replace;
    select_left .innerHTML= select_left_replace;
    select_right.innerHTML = select_right_replace;
    select_down.innerHTML = select_down_replace;

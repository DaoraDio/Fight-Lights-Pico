...
fadeout_speed = 6 #fadeout speed when the button is released, higher = faster
fadein_speed = 20 #fadein speed when the button is pressed, higher = faster

input_reset_time = 50 #input leniency for fgc input, the higher the number the bigger the leniency to input the command

save_stats = True #toggle stat logging on or off. Stats are saved every 30seconds
...
ps = button.ps.set_config((1,2,3,4,5,6,7,8), light_blue, False)
